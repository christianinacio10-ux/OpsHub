...
assert.strictEqual(Logica.deveAplicarSemente([], 'DEPARTAMENTOS', 0), false, 'aba existente vazia nao recebe semente');
assert.strictEqual(Logica.deveAplicarSemente(['DEPARTAMENTOS'], 'DEPARTAMENTOS', 1), false);
assert.strictEqual(Logica.deveAplicarSemente(['CONTROLES'], 'DEPARTAMENTOS', 0), false);
